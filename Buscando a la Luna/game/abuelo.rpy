...
label abuelo:
    ...
    #historia con abuelo
    #show scene bg downtown
    #show mc at left
    #with dissolve
    
    centered "Triste nuestra amiga por no descrubrir el por que la luna no estaba sobre nuestro hermoso cielo esa noche, decide volver a casa, pero en el camino se encuentra con una persona muy especial y muy sabia, su abuelo."
    
    #show abuelo at right
    #with dissolve
